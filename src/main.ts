...
import { faUserSecret, faCloudArrowUp, faFileCircleQuestion, faChalkboardUser, faFileCircleCheck, faBookOpenReader, faGraduationCap, faTriangleExclamation, faBullhorn } from '@fortawesome/free-solid-svg-icons'
