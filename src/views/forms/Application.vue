...
type applicationData = {
    ...
    studentId: number;
    email: string;
    isCurrentlyOverseas: boolean;
    willComeBackToNZ: boolean;
    isCitizen: boolean;
    hasWorkVisa: boolean;
    degree: string;
...
const validateWillComeBackToNZ = (rule: any, value: any, callback: any) => {
    if (data.isCurrentlyOverseas === false) {
        callback();
...
const dataRules = reactive<FormRules>({
    ...
    willComeBackToNZ: [ // isCurrentlyOverseas 的子问题
...
<template>
    <div class="application-header">
        ...
        <span>your student Id: 226537590</span>
    </div>
    <div class="application-container">

        <div class="progress-bar">
            <el-steps :active="step" align-center process-status="process" finish-status="finish" space="200px">
                <el-step title="" description="" :status="statusArr[0]" />
                <el-step title="" description="" :status="statusArr[1]" />
                <el-step title="" description="" :status="statusArr[2]" />
                <el-step title="" description="" :status="statusArr[3]" :icon="UploadFilled" />
            </el-steps>
        </div>
                ...
                <Transition>
                    <div v-show="stepArr[0]">
                        ...
                        <el-form-item label="UPI" prop="upi">
                            <el-input v-model="data.upi" />
                        </el-form-item>
                        <el-form-item label="Student ID" prop="studentId">
                            <el-input v-model.number="data.studentId" />
                        </el-form-item>
